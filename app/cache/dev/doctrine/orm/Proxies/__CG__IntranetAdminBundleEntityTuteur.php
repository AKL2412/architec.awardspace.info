 ...
 */
class Tuteur extends \Intranet\AdminBundle\Entity\Tuteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'id', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'nom', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'prenom', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'telephone', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'email', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'adresse', '' . "\0" . 'Intranet\\AdminBundle\\Entity\\Tuteur' . "\0" . 'date');
        }
