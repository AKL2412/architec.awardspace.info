...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'internetsite.preinscription' => 'getInternetsite_PreinscriptionService',
            ...
            'outil_service.param' => 'getOutilService_ParamService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'architecawardspace', 'user' => 'junior', 'password' => 'junior', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_d5ec64c555bf6679350f9c839e2b0965f3fe46b719e2697724bf112e9d5c6e73');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d5ec64c555bf6679350f9c839e2b0965f3fe46b719e2697724bf112e9d5c6e73');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_d5ec64c555bf6679350f9c839e2b0965f3fe46b719e2697724bf112e9d5c6e73');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/opt/lampp/htdocs/architec.awardspace.info/src/Intranet/AdminBundle/Entity', 1 => '/opt/lampp/htdocs/architec.awardspace.info/src/Internet/siteBundle/Entity', 2 => '/opt/lampp/htdocs/architec.awardspace.info/src/OC/UserBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Intranet\\AdminBundle\\Entity');
        $f->addDriver($e, 'Internet\\siteBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('IntranetAdminBundle' => 'Intranet\\AdminBundle\\Entity', 'InternetsiteBundle' => 'Internet\\siteBundle\\Entity', 'OCUserBundle' => 'OC\\UserBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'internetsite.preinscription' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Internet\siteBundle\Form\PreinscriptionType A Internet\siteBundle\Form\PreinscriptionType instance.
     */
    protected function getInternetsite_PreinscriptionService()
    {
        return $this->services['internetsite.preinscription'] = new \Internet\siteBundle\Form\PreinscriptionType('http://localhost/architec.awardspace.info/web/app_dev.php/se-preinscrire');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/opt/lampp/htdocs/architec.awardspace.info/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'outil_service.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Outil\ServiceBundle\Antispam\Antispam A Outil\ServiceBundle\Antispam\Antispam instance.
     */
    ...
    /**
     * Gets the 'outil_service.param' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Outil\ServiceBundle\Param\param A Outil\ServiceBundle\Param\param instance.
     */
    protected function getOutilService_ParamService()
    {
        return $this->services['outil_service.param'] = new \Outil\ServiceBundle\Param\param();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/opt/lampp/htdocs/architec.awardspace.info/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('kwsyaby@gmail.com');
        $a->setPassword('dieumerci');
        $a->setAuthMode('login');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/lampp/htdocs/architec.awardspace.info/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/opt/lampp/htdocs/architec.awardspace.info/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/opt/lampp/htdocs/architec.awardspace.info/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/lampp/htdocs/architec.awardspace.info/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev',
            ...
            'mailer_user' => 'kwsyaby@gmail.com',
            'mailer_password' => 'dieumerci',
            ...
            'urlpreincription' => 'http://localhost/architec.awardspace.info/web/app_dev.php/se-preinscrire',
            ...
            'debug.container.dump' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/profiler',
            ...
            'router.resource' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'kwsyaby@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'dieumerci',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/architec.awardspace.info/app/cache/dev/doctrine/orm/Proxies',
